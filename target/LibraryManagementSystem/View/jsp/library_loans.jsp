      ...
      <div class="loans-section">
        ...
        <table>
          ...
          <c:forEach var="loan" items="${loans}">
            <tr>
              <td>${loan.id}</td>
              <td><img src="${pageContext.request.contextPath}/book-image/${loan.bookId}" alt="Book Cover" style="width:40px;height:60px;object-fit:cover;border-radius:3px;" /></td>
              <td>
                <c:choose>
                  <c:when test="${not empty loan.userImageData}">
                    <img src="${pageContext.request.contextPath}/user-image/${loan.userId}" alt="User" style="width:32px;height:32px;border-radius:50%;object-fit:cover;" />
                  </c:when>
                  <c:otherwise>
                    <img src="${pageContext.request.contextPath}/assets/default-avatar.jpg" alt="Default" style="width:32px;height:32px;border-radius:50%;object-fit:cover;" />
                  </c:otherwise>
                </c:choose>
              </td>
