    ...
    <div class="main-content">
      <div class="about-card">
        ...
        <div class="about-desc">
          ...
          • Search and explore a wide range of books<br>
          • Borrow and return books online<br>
          • Track your reading history and activities<br>
          <br>
          <b>Features for Admins:</b><br>
          • Manage books and members<br>
          • Oversee all library loans and returns<br>
          • View and analyze library statistics<br>
          <br>
