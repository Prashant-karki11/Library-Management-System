...
<html>
<head>
  <title>Recent Activities - Library Management System</title>
...
<div class="container">
  <aside class="sidebar">
    ...
    <ul>
      ...
      <li><a href="${pageContext.request.contextPath}/recent_activities" class="active"><i class="fas fa-clock"></i> Recent Activities</a></li>
    </ul>
  </aside>
  <main class="content">
      ...
      <table>
        ...
        <c:forEach var="activity" items="${activities}">
          <tr>
            ...
            <td><fmt:formatDate value="${activity.borrowDate}" pattern="MMM dd, yyyy" /></td>
            <td><fmt:formatDate value="${activity.dueDate}" pattern="MMM dd, yyyy" /></td>
            <td class="${activity.status == 'Borrowed' ? 'status-overdue' : 'status-returned'}">${activity.status}</td>
          </tr>
        </c:forEach>
        </tbody>
      </table>
