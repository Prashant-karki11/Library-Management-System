    ...
    <aside class="sidebar">
        ...
        <ul>
            ...
            <c:if test="${sessionScope.user != null && sessionScope.user.role == 'admin'}">
                ...
                <li><a href="${pageContext.request.contextPath}/books" class="active"><i class="fas fa-book"></i> Books</a></li>
            ...
            <table>
                ...
                <c:forEach var="book" items="${books}">
                    <tr>
                        ...
                        <td>${book.genre}</td>
                        <td>${book.pages}</td>
                        <td><img src="${book.image}" alt="Book Cover" style="width:40px;height:60px;object-fit:cover;border-radius:3px;"></td>
                        <c:if test="${sessionScope.user != null && sessionScope.user.role == 'admin'}">
                          <td>
